...
const MerryMembership = () => {
  ...
  // const filterPackage = packages.filter((item) => {
              ...
              <div className="flex-col justify-start items-start gap-6 flex w-full">
                <p className="w-full text-slate-800 text-xl md:text-2xl font-bold ">
                  Merry Membership Package
                    ...
                    {hasPackage ? (
                      <div className="h-auto md:h-[222px] w-full px-4 md:px-8 pt-8 pb-6 bg-gradient-to-br from-pink-900 to-pink-300 rounded-[32px] shadow flex flex-col justify-start items-end gap-4">
                        <div className="self-stretch pb-10 border-b border-pink-400 flex justify-between items-start flex-wrap">
                          <div className="flex justify-start items-center gap-6 flex-wrap">
                            <div className="w-full md:w-[319px] flex justify-start items-start gap-4">
                              <div className="w-[78px] h-[78px] p-[21px] bg-slate-50 rounded-2xl flex justify-center items-center">
                                <img src={icons} alt="" />
                              </div>
                            ...
                            <div className="w-full md:w-[357px] flex flex-col justify-center items-center gap-2">
                              ...
                              <div className="flex justify-start items-start gap-3">
                                <p className="grow shrink basis-0 text-pink-100 text-base font-normal">
                                  Up to {merry_limit} Merry per day
                                </p>
                              </div>
                            </div>
                          </div>
                          <button className="px-4 py-1 bg-red-100 rounded-[99px] flex justify-center items-center gap-1">
                        ...
                        <button
                          ...
                          className="px-2 py-1 rounded-2xl flex justify-center items-center gap-2"
                        >
                      ...
                      <div className="h-auto md:h-[222px] w-full px-4 md:px-8 pt-8 pb-6 bg-gray-100 rounded-[32px] shadow flex flex-col justify-center items-center">
