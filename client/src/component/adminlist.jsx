  ...
  <div className=" flex grow shrink basis-0 self-stretch rounded-2xl flex-col mt-[100px]">
    <table className="self-stretch bg-gray-300 justify-start items-start inline-flex gap-[120px] rounded-t-lg">
      ...
      <div className="h-[88px] justify-start items-start flex   " >
        <div className=" self-stretch px-[11px] py-1 justify-center items-center flex relative left-8">0</div> 
        <div className="h-[88px]  justify-center items-center gap-2.5 flex">
          <div className="text-justify text-black text-base font-normal  leading-normal mr-[90px] ml-14">1</div>
        </div>
        <div className="w-20 h-[88px] px-4 py-8 justify-start items-center gap-2.5 flex mr-[100px]">
          <div className="w-8 h-8 px-[3.20px] py-[4.80px] justify-center items-center flex ">2</div>
        </div>
        ...
        <div className="w-[120px] h-[88px] pl-[27px] pr-7 justify-center items-start flex">
        <div className="grow shrink basis-0 self-stretch px-[3px] py-[1.50px] justify-center items-center inline-flex relative right-28">3</div> 
        <div className="grow shrink basis-0 self-stretch px-[3px] py-[1.50px] justify-center items-center inline-flex relative right-28">4</div> 
      </div>
      </div>
